...
{
    [Serializable]
    public class cAnimatedTile : TileBase
    {
        ...
        public static void CreateAnimatedTile()
        {
            ...
            AssetDatabase.CreateAsset(ScriptableObject.CreateInstance<cAnimatedTile>(), path);
        }
#endif
    }

#if UNITY_EDITOR
    [CustomEditor(typeof(cAnimatedTile))]
    public class AnimatedTileEditor : Editor
    {
        private cAnimatedTile tile { get { return (target as cAnimatedTile); } }
